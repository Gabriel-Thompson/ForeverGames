...
resource actionGroup 'Microsoft.Insights/actionGroups@2023-01-01'={
  ...
  properties:{
    ...
    enabled:true
    emailReceivers:[for (email,index) in contactEmails:{name:'operator-${index}' emailAddress:email useCommonAlertSchema:true}]
  }
}
...
resource databaseAlerts 'Microsoft.Insights/metricAlerts@2018-03-01'=[for definition in [
  ...
  properties:{
    ...
    windowSize:'PT15M'
    criteria:{'odata.type':'Microsoft.Azure.Monitor.SingleResourceMultipleMetricCriteria' allOf:[{name:definition.name metricNamespace:'Microsoft.DBforPostgreSQL/flexibleServers' metricName:definition.metric operator:'GreaterThan' threshold:definition.threshold timeAggregation:'Average' criterionType:'StaticThresholdCriterion'}]}
