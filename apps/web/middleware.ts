...
const protectedPrefixes=["/library","/connections","/legacy","/reservations","/settings","/games"];
...
export const config={matcher:["/library/:path*","/connections/:path*","/legacy/:path*","/reservations/:path*","/settings/:path*","/games/:path*"]};
